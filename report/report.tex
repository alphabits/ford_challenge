...
\newcommand\folder[1]{{\ttfamily #1}}

% Control spacing around hline in table
% Read more at: https://www.msu.edu/~harris41/latex_tablespacing.html
...
\def\thesisyear{24. juni 2011} % Year thesis submitted
\def\thesisnumber{70}  % Only number no year
\def\thesisauthor{Anders Hørsted - s082382} % Thesis author
...
\include{chapters/result-summary}
